package com.ujuit.datamove.createClass.gencode.main;

import java.io.File;

import com.ujuit.datamove.createClass.gencode.generate.GenCode;
import com.ujuit.datamove.createClass.gencode.generate.GenPojo;
import com.ujuit.datamove.createClass.gencode.utils.GenFileUtil;
import com.ujuit.datamove.futruebasic.pojo.FutrueBasicPojo;
...
public class GenFactory {
	...
	public void createOneCode() {
		GenCode gcm = new GenCode();
		gcm.genFile(FutrueBasicPojo.class);
		System.out.println("创建成功");
	}
}
