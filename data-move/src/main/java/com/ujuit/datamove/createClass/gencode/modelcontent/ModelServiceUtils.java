...
public class ModelServiceUtils {
	 ...
	 * @param pojoClassName 对象名（org.qisys.db.sec.equinfo.model.RtnTongLianEquinfo）
	 * @param modelName     模块名 （equinfo）
	 * @param fieldName     主键名称
	 * @return
	 */
...
//		sb.append("import com.ujuit.core.mybatis.DataItem;" + ClassUtil.NEXT_ROW);
