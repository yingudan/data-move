...
import com.ujuit.datamove.createClass.gencode.tablestructure.TableStructs;
import com.ujuit.datamove.createClass.gencode.tablestructure.TableUtils;
...
public class GenPojo {
	...
	public void genPojoMain(String packageName, String modelName, String tableName, String databaseName,
		...
		sb.append("import com.ujuit.datamove.createClass.gencode.annotation.GenField; \r\n");
		sb.append("import com.ujuit.datamove.createClass.gencode.annotation.GenModel; \r\n");
		sb.append("import com.ujuit.datamove.createClass.gencode.annotation.GenTable; \r\n");
	...
	public static void main(String[] arg) {
		...
		// * @param databaseName 数据库的名称
		// H_T_FUND
		genPojoMain.genPojoMain("com.ujuit.datamove", "futruebasic", "t_futrue_basic", "orderv4", "FutrueBasic",
				"子账户历史持仓");
	}
